    ...
    db.collection('trades')
        ...
        .then((query) => {
            ...
            query.forEach((doc) => {
                ...
                if (docData.sellingUserId !== req.user.uid)
            ...
            db.collection('trades')
                ...
                .then((doc) => {
                    ...
                    return res.status(200).send({
                        general: `Trade ${doc.id} updated successfully!`,
                    });
                });
        })
        .catch((err) => {
            ...
            .then(() => {
                Promise.all([
                    sellingUserDoc.update({
                        accountBalance:
                            firestoreRef.FieldValue.increment(costOfTrade),
                    }),
                ...
                .then(() => {
                    ...
                    db.collection('trades')
                        ...
                        .then(() => {
                            return res
                                .status(200)
                                .json({ general: 'Deleted successfully!' });
                        });
                })
                .catch((err) => {
                    console.error(err);
